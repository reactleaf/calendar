...
title: Introduction
description: >-
  Calendar with single, multiple, and range selection—Temporal dates,
  optional time editing, and keyboard-friendly interaction.
---

**`@reactleaf/calendar`** is a date and optional-time picker for React. It targets the same product niche as [react-infinite-calendar](https://github.com/clauderic/react-infinite-calendar), but the implementation is new: built for React 19, with **`@js-temporal/polyfill`** for values.
